...
break;
case 22:return "REXEC";
break;
case 23:return "RANGE";
break;
case 24:return "PLUSASSIGN";
break;
case 25:return "MINUSASSIGN";
break;
case 26:return "MULTIPLAYASSIGN";
break;
case 27:return "DIVIDEASSIGN";
break;
case 28:return "EQUALS";
break;
case 29:return "NOTEQUALS";
break;
case 30:return "GTE";
break;
case 31:return "LTE";
...
case 36:return "NOT";
break;
case 37:return "MULTIPLY";
break;
case 38:return "DIVIDE";
break;
case 39:return "MINUS";
break;
case 40:return "PLUS";
break;
case 41:return "ASSIGN";
break;
case 42:return "BITOR";
break;
case 43:return "BITAND";
break;
case 44:return "LBRACKET";
break;
case 45:return "RBRACKET";
break;
case 46:return "LSQUARE";
break;
case 47:return "RSQUARE";
break;
...
case 56:return "NULL";
break;
case 57:return "UNDEFINED";
break;
case 58:return "FUNCTION";
break;
case 59:return "FUNCTION";
break;
case 60:return "FUNCTION";
break;
case 61:return "VARIABLE";
break;
case 62:return "VARIABLE";
break;
case 63:return "IF";
break;
case 64:return "ELSE";
...
break;
case 74:return "PRINT";
break;
case 75:return "ERROR";
break;
case 76:return "IDENTIFIER";
break;
case 77:return "HEXNUMBER";
break;
case 78:return "OCTALNUMBER";
break;
case 79:return "BINARYNUMBER";
break;
case 80:return "NUMBER";
break;
case 81:return "EOF";
break;
...
rules: [/^(?:\/\/.*)/,/^(?:#.*)/,/^(?:\/\*)/,/^(?:.*?(\/\*))/,/^(?:.*?(\*\/))/,/^(?:([\n\r])+)/,/^(?:\s+)/,/^(?:")/,/^(?:")/,/^(?:\\)/,/^(?:[^"\\]*)/,/^(?:')/,/^(?:')/,/^(?:\\)/,/^(?:[^'\\]*)/,/^(?:[n])/,/^(?:[r])/,/^(?:[t])/,/^(?:[0])/,/^(?:['])/,/^(?:["])/,/^(?:\{\{)/,/^(?:\}\})/,/^(?:\.\.)/,/^(?:\+=)/,/^(?:-=)/,/^(?:\*=)/,/^(?:\/=)/,/^(?:==)/,/^(?:!=)/,/^(?:>=)/,/^(?:<=)/,/^(?:>)/,/^(?:<)/,/^(?:and\b)/,/^(?:or\b)/,/^(?:not\b)/,/^(?:\*)/,/^(?:\/)/,/^(?:-)/,/^(?:\+)/,/^(?:=)/,/^(?:\|)/,/^(?:&)/,/^(?:\{)/,/^(?:\})/,/^(?:\[)/,/^(?:\])/,/^(?:\()/,/^(?:\))/,/^(?:\.)/,/^(?:,)/,/^(?::)/,/^(?:\?)/,/^(?:true\b)/,/^(?:false\b)/,/^(?:null\b)/,/^(?:undefined\b)/,/^(?:function\b)/,/^(?:func\b)/,/^(?:fun\b)/,/^(?:var\b)/,/^(?:let\b)/,/^(?:if\b)/,/^(?:else\b)/,/^(?:loop\b)/,/^(?:while\b)/,/^(?:for\b)/,/^(?:in\b)/,/^(?:step\b)/,/^(?:by\b)/,/^(?:return\b)/,/^(?:break\b)/,/^(?:continue\b)/,/^(?:print\b)/,/^(?:error\b)/,/^(?:([a-zA-Z_$][a-zA-Z0-9_$]*))/,/^(?:0x([0-9a-fA-F]+)\b)/,/^(?:0o([0-7]+)\b)/,/^(?:0b([01]+)\b)/,/^(?:(([0-9]+(\.[0-9]+)?)|(\.[0-9]+))\b)/,/^(?:$)/,/^(?:.)/],
